 ...
 */
namespace KrokedilAvardaDeps\Composer;

use KrokedilAvardaDeps\Composer\Autoload\ClassLoader;
use KrokedilAvardaDeps\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('KrokedilAvardaDeps\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
