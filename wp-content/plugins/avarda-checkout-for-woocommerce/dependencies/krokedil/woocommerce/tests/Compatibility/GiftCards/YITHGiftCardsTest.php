...
namespace KrokedilAvardaDeps\Krokedil\WooCommerce\Tests\Compatibility\GiftCards;

use KrokedilAvardaDeps\Krokedil\WooCommerce\Compatibility\Giftcards\YITHGiftCards;
...
class YITHGiftCardsTest extends TestCase
{
    ...
    public function setUp() : void
    {
        ...
        $this->mock_package = $this->getMockBuilder('KrokedilAvardaDeps\\Krokedil\\WooCommerce\\KrokedilWooCommerce')->disableOriginalConstructor()->getMock();
