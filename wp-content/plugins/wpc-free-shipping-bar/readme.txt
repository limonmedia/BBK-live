...
Visit our [live demo](https://demo.wpclever.net/woofc/?utm_source=content&utm_medium=wpcfb&utm_campaign=wporg "live demo") to see how this plugin works.
...
- Compatible with [WPC Fly Cart](https://wordpress.org/plugins/woo-fly-cart/) & [WPC Added to Cart Notification](https://wordpress.org/plugins/woo-added-to-cart-notification/) plugins
