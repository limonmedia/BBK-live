...
= Product Catalog Feed 2.2.0 =

* New integration with the WooCommerce Cost of Goods by PixelYourSite plugin. You can enable cost of goods for Google Merchant feeds.

* Various code improvements and fixing small bugs.
...
= Product Catalog Feed 2.1.1 =

* New stock options related to "available on backorder" products
...
= Product Catalog Feed 2.1.0 =

* Ensuring compatibility with High-Performance Order Storage (HPOS)

* Declaring compatibility with WooCommerce 7.3

* Declaring compatibility with WordPress 6.1

* Fixing various issues, code refactoring
