<?php
	...
	<div class="wvs-archive-variations-wrapper" data-threshold_min="<?php echo absint( $variation_threshold_min ); ?>" data-threshold_max="<?php echo absint( $variation_threshold_max ); ?>" data-total_children="<?php echo absint( $total_children ); ?>"  data-total_attribute="<?php echo absint( $total_attribute ); ?>" data-product_id="<?php echo absint( $product->get_id() ); ?>" data-product_variations="<?php echo esc_attr(  $variations_attr); ?>">
		...
		<?php else : ?>
			<ul class="variations">
				...
				<?php if ( $disable_catalog_mode_on_single_attribute && $clear_on_archive && $enable_catalog_mode && 1 === $total_attribute ) : ?>
					<li class="wvs_archive_reset_variations">
						<a class="wvs_archive_reset_variations_link" href="#"><?php esc_html_e( 'Clear', 'woo-variation-swatches-pro' ); ?></a>
					</li>
				<?php endif; ?>
...
<?php
do_action( 'woo_variation_swatches_archive_after_add_to_cart_form' );
