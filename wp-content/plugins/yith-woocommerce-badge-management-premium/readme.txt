...
= 3.15.0 - Released on 25 February 2025 =

* New: support for WooCommerce 9.7

= 3.14.0 - Released on 31 January 2025 =

* New: support for WooCommerce 9.6
* Update: YITH plugin framework
* Fix: display percentage badges for discounts below one unit

= 3.13.0 - Released on 16 December 2024 =

* New: support for WooCommerce 9.5
* Update: YITH plugin framework

= 3.12.0 - Released on 18 November 2024 =
...
* Tweak: add floatval for prevent error on operation between float and strings
* Update: YITH plugin framework
* Fix: price errors with Dynamic pricing and discounts

= 3.10.0 - Released on 07 August 2024 =

* New: support for WooCommerce 9.2
* Update: YITH plugin framework
* Fix: low stock badge rule not working
...
* Tweak: improved Dynamic Pricing compatibility checking also for product variations match with Badge Rules
* Update: YITH plugin framework
* Fix: avoid errors while replacing WC on-sale badge
* Dev: new filter 'yith_wcbm_valid_apply_also_variations'
...
= 3.6.0 - Released on 23 April 2024 =

* New: support for WooCommerce 8.8
* Tweak: recent product date filter added
* Update: YITH plugin framework
...
* Tweak: dynamic pricing compatibility class code refactoring
* Tweak: included tax calculation in badge placeholders
* Fix: PHP 8.2 error
* Dev: new filter 'yith_wcbm_placeholder_round_precision'
* Dev: new filter 'yith_wcbm_placeholder_include_tax' to avoid tax calculation in badge placeholders

= 3.4.0 - Released on 08 February 2024 =

* New: support for WooCommerce 8.6
* Update: YITH plugin framework
* Fix: round percentage discount value

= 3.3.0 - Released on 16 January 2024 =

* New: support for WooCommerce 8.5
* Tweak: improved badge editing settings style
* Update: YITH plugin framework
...
* New: variable products placeholders working on simple products
* New: badge placeholders handled in variable products
* New: variable products tab in placeholders modal
* Tweak: added default text color in admin Badges list
* Update: YITH plugin framework
...
* Dev: call to casper server to get the badges
...
* Update: YITH plugin framework
* Update: language files
* Fix: query to retrieve best-seller products
* Fix: calendar fields visibility in variation badges options
* Tweak: removed active rule option from the rule editing panel

= 2.22.0 - Released on 16 October 2023 =
