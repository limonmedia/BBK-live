...
if ( ! class_exists( 'YITH_WCBM_Admin_Premium' ) ) {
	...
	class YITH_WCBM_Admin_Premium extends YITH_WCBM_Admin {
		...
		public function add_premium_admin_tab( $admin_tabs_free ) {
			...
			$premium_tabs = array(
				'badge-rules' => array(
					'title'       => esc_html__( 'Badge Rules', 'yith-woocommerce-badges-management' ),
					'description' => esc_html__( 'Advanced rules to set in which products to show your badges.', 'yith-woocommerce-badges-management' ),
			...
			return array_merge( array_slice( $admin_tabs_free, 0, $settings_index ), $premium_tabs, array_slice( $admin_tabs_free, $settings_index ) );
		}
		...
		public function handle_premium_panel_args( $args ) {
			...
			$args['your_store_tools'] = $this->get_your_store_tools_tab_args();
					...
					'data'        => array(
						...
						'modals'            => array(
							'badgePlaceholders' => array(
								...
								'content' => yith_wcbm_get_view_html( 'modals/badge-placeholders/content.php' ),
							),
						),
						'actions'           => array(
			...
			return array(
				'items' => array(
					'wishlist'               => array(
						...
						'icon_url'       => YITH_WCBM_ASSETS_URL . '/images/plugins/wishlist.svg',
					...
					'gift-cards'             => array(
						...
						'icon_url'       => YITH_WCBM_ASSETS_URL . '/images/plugins/gift-cards.svg',
					...
					'request-a-quote'        => array(
						...
						'icon_url'    => YITH_WCBM_ASSETS_URL . '/images/plugins/request-a-quote.svg',
					...
					'ajax-product-filter'    => array(
						...
						'icon_url'    => YITH_WCBM_ASSETS_URL . '/images/plugins/ajax-product-filter.svg',
					...
					'product-addons'         => array(
						...
						'icon_url'    => YITH_WCBM_ASSETS_URL . '/images/plugins/product-add-ons.svg',
					...
					'dynamic-pricing'        => array(
						...
						'icon_url'    => YITH_WCBM_ASSETS_URL . '/images/plugins/dynamic-pricing-and-discounts.svg',
					...
					'customize-my-account'   => array(
						...
						'icon_url'    => YITH_WCBM_ASSETS_URL . '/images/plugins/customize-myaccount-page.svg',
					...
					'recover-abandoned-cart' => array(
						...
						'icon_url'    => YITH_WCBM_ASSETS_URL . '/images/plugins/recover-abandoned-cart.svg',
