...
== Changelog ==
= Version 4.12.0 - Released on 10 December 2024 =
 * New: support for WooCommerce 9.5
 * Update: YITH plugin framework

= Version 4.11.0 - Released on 13 November 2024 =
 * New: support for WordPress 6.7
 * New: support for WooCommerce 9.4
 * Update: YITH plugin framework

= Version 4.10.0 - Released on 23 September 2024 =
 * New: support for WooCommerce 9.3
 * New: option to update the single product message on quantity change
 * New: option to calculate points considering unit prices or product subtotal
 * Update: YITH plugin framework
 * Fix: php 8.2 dynamic property error within email class
 * Fix: issue on Bulk action - Add order to previous orders with date
 * Dev: added filter ywapr_force_blocks_scripts_frontend

= Version 4.9.0 - Released on 22 August 2024 =
 * New: support for WooCommerce 9.2
 * Update: YITH plugin framework
 * Fix: earning rules not apply to product categories
 * Dev: added action ywpar_level_updated

= Version 4.8.0 - Released on 24 July 2024 =
 * New: support for WordPress 6.6
 * New: support for WooCommerce 9.1
 * Update: YITH plugin framework
 * Fix: refund calculation on partial refunds
 * Fix: shortcode of best customers

= Version 4.7.0 - Released on 27 June 2024 =
 * New: support for WooCommerce 9.0
 * Update: YITH plugin framework
 * Fix: string localization in points message
 * Fix: issue in bulk action - points to previous orders
 * Fix: create share coupon error when YITH WooCommerce Gift Cards is activated
 * Fix: css code for shared coupons table in my account page 
 * Dev: added filter ywpar_import_csv_file
 * Dev: added filter ywpar_customer_points_shortcode_show_customer
 * Tweak: better management of affiliate integration

= Version 4.6.0 - Released on 21 May 2024 =
 * New: support for WooCommerce 8.9
 * Update: YITH plugin framework
 * Fix: string localization in points message
 * Dev: added filter ywpar_customer_history_items_per_page
 * Dev: added filter ywpar_expiration_email_send

= Version 4.5.0 - Released on 18 April 2024 =
 * New: support for WooCommerce 8.8
 * Update: YITH plugin framework
 * Fix: expired points emails with WPML
 * Dev: added filter ywpar_calculate_order_points_from_items_type

= Version 4.4.0 - Released on 26 March 2024 =
 * New: support for WordPress 6.5
 * New: support for WooCommerce 8.7
 * New: added Last Year filter to Customers Points shortcode
 * Update: YITH plugin framework

= Version 4.3.0 - Released on 22 February 2024 =
 * New: support for WooCommerce 8.6
 * Update: YITH plugin framework
 * Update: Language files
 * Fix: creation of dynamic property deprecated errors in emails classes
 * Fix: calculation in affiliate points based on the order subtotal
 * Dev: added filter ywpar_frontend_scripts_deps
 * Dev: added filter ywpar_product_points_use_transient
 * Dev: added filter ywpar_get_points_earned_from_price

= Version 4.2.0 - Released on 23 January 2024 =
 * New: support for WooCommerce 8.5
 * Update: YITH plugin framework
 * Update: Language files
 * Fix: issue with refund when there are earning rules
 * Fix: issue on worth value in earning points message
 * Dev: added filter ywpar_get_product_price

= Version 4.1.0 - Released on 20 December 2023 =
 * New: support for WooCommerce 8.4
 * Update: YITH plugin framework
 * Update: Language files
 * Dev: added filter calculate_points_for_cart_item
 * Dev: added filter yith_wpar_points_options_subtabs

= Version 4.0.0 - Released on 14 November 2023 =
 * New: support for WordPress 6.4
 * New: support for WooCommerce 8.3
 * Update: YITH plugin framework
 * Update: Language files
 * Fix: issue during complete profile extra points
 * Fix: block assets css
 * Fix: conditionals for loading blocks
 * Dev: added filter ywpar_update_new_customer_level
 * Dev: added filter ywpar_check_coupon_points_from_item
 * Dev: added filter ywpar_customers_table_list_args
 * Dev: added filter ypwar_get_best_users_calc_type
 * Dev: added filter ywpar_load_blocks

= Version 3.26.0 - Released on 18 October 2023 =
...
= Version 3.25.0 - Released on 14 September 2023 =
 * New: support for WooCommerce 8.1
 * Update: YITH plugin framework
 * Fix: reviews giving points on replies with YITH WooCommerce Advanced Reviews
 * Dev: added action ywpar_updated_points_referral

= Version 3.24.0 - Released on 16 August 2023 =
 * New: support for WordPress 6.3
 * New: support for WooCommerce 8.0
 * New: support to WooCommerce blockified templates
 * Update: YITH plugin framework

= Version 3.23.0 - Released on 06 July 2023 =
 * New: support for WooCommerce 7.9
 * Update: YITH plugin framework
 * Fix: messages on update_shipping_method

= Version 3.22.0 - Released on 19 June 2023 =
 * New: support for WooCommerce 7.8
 * Update: YITH plugin framework
 * Fix: added timer in points field in order to avoid multiple calls on keyup event in reward message
 * Fix: description on referral user delete registration points remove
 * Fix: placeholder for Points label in my account pages templates
 * Fix: added missing {discount} placeholder to Updated Points email
 * Dev: added filter ywpar_redeeming_check_rule_validation
 * Dev: added filter ywpar_get_product_points_cache
 * Dev: added filter ywpar_wc_get_orders_args
 * Dev: added filter ywpar_calculate_user_total_orders_amount_last_order

= Version 3.21.0 - Released on 11 May 2023 =
 * New: support for WooCommerce 7.7
 * Update: YITH plugin framework
 * Fix: avoid to show products with disabled reviews for review banner
 * Fix: referral get points using its own email in a guest order
...
* Update: YITH plugin framework
* Dev: new filter 'ywpar_verified_owner_review_exp' to disable the assigment of extra points to a review if the owner is not verified
* Dev: new filter 'ywpar_get_order_status_for_review' to choose the order status that an order must have to retrieve the products available for a review.

= Version 3.11.0 - Released on 13 July 2022 =
* New: support for WooCommerce 6.7
* Update: YITH plugin framework
* Fix: remove points from the total collected points counter when an order is refunded, canceled, or failed
* Fix: fixed issue on calculation points
* Fix: fixed expiration emails for orphaned points logs

= Version 3.10.0 - Released on 13 June 2022 =
* New: support for WooCommerce 6.6
* Update: YITH plugin framework
* Fix: fixed issue on share points when percent redemption conversion type is set
* Fix: fixed issue with earned points in renew orders
* Dev: new filter 'ywpar_force_use_points_from_product' to force the calculation of points inside the order
* Dev: added action 'ywpar_extra_points_for_daily_login' triggered after daily login points assignment

= Version 3.9 - Released on 9 May 2022 =
* New: support for WordPress 6.0
* New: support for WooCommerce 6.5
* Update: YITH plugin framework
* Fix: fixed issues with UX Builder of Flatsome theme
* Fix: fixed issue with partial refunds
* Fix: changed my account view template to avoid link on order if affiliate action

= Version 3.8 - Released on 6 April 2022 =
* New: support for WooCommerce 6.4
* Update: YITH plugin framework
* Fix: fixed show total points in points history
* Fix: forced the rewards coupon to be created with usage_count to 0
* Fix: fixed integration with YITH WooCommerce Subscription when the main order has multiple subscriptions
* Fix: fixed renew points calculation
* Fix: the number of points assigned for single renewal order with YITH WooCommerce Subscription
* Fix: fixed issues with UX Builder of Flatsome theme
* Fix: changed array sorting in banner target levels template
* Dev: new filter 'ywpar_force_calculation_of_order_points' to force the calculation of earned point after the order is placed
* Dev: new filter 'yith_extrapoints_usermeta_table' to change the default usermeta table
