						...
						<div class="conversion-currencies">
							...
							foreach ( $currencies as $current_currency ) :
								...
								<p>
									...
									<input type="number" name="<?php echo esc_attr( $current_name ); ?>[discount]"
										step="1"
										min="0" id="<?php echo esc_attr( $current_id ); ?>-discount"
										value="<?php echo esc_attr( $discount ); ?>"/>
									<span>% (<?php echo wp_kses_post( $current_currency . ' - ' . get_woocommerce_currency_symbol( $current_currency ) ); ?>) <?php esc_html_e( 'discount', 'yith-woocommerce-points-and-rewards' ); ?></span>
								</p>
							<?php endforeach; ?>
						</div>
						<div><span
