...
function scfw_free_import_export_settings_content() {
    ...
    <div class="thedotstore-main-table res-cl scfw-import-export-table scfw-upgrade-pro-to-unlock">
        <h2><?php esc_html_e( 'Import & Export Settings', 'size-chart-for-woocommerce' ); ?><div class="scfw-pro-label"></h2>
                    ...
                    <td>
                        <div class="whsm_main_container export_settings_container">
                            <p class="scfw_button_container">
                                <input type="button" name="scfw_export_settings_pro" id="scfw_export_settings" class="button button-primary" value="<?php esc_attr_e( 'Export', 'size-chart-for-woocommerce' ); ?>" />
                            </p>
                ...
                <tr>
                    ...
                    <td>
                        <div class="scfw_main_container import_settings_container">
                            ...
                            <p class="scfw_button_container">
                                <input type="button" name="scfw_import_settings_pro" id="scfw_import_settings_pro" class="button button-primary" value="<?php esc_attr_e( 'Import', 'size-chart-for-woocommerce' ); ?>" />
                            </p>
                            <p class="scfw_content_container">
