...
class SCFW_Size_Chart_For_Woocommerce {
	...
	public function __construct( $name, $version, $post_type_name ) {
		...
		add_filter( 'plugin_row_meta', array($this, 'scfw_plugin_row_meta_action_links'), 20, 3 );
	}
	...
	private function scfw_define_admin_hooks() {
		...
		$this->loader->add_action( 'admin_footer', $plugin_admin, 'scfw_size_chart_posts_close_div', 1 );
	...
	public function scfw_plugin_action_links_callback( $actions ) {
		$custom_actions = array(
			...
			'docs'      => sprintf(
				...
				esc_url( 'https://docs.thedotstore.com/collection/233-product-size-charts' ),
