<div class="panel woocommerce_options_panel" id="variable_product_options" style="display:none;">
	...
	<div class="options_group">
		...
		<?php
			if ( class_exists( 'Woo_Variation_Gallery' ) || class_exists( 'WC_Additional_Variation_Images' ) || apply_filters( 'wp_all_import_is_show_additional_variation_imgs_option', false ) === true ) {
			?>
				<p class="form-field wpallimport-radio-field">
